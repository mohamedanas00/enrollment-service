...
export const InstructorNotification = async ({req,isEnrolled,operation}={}) => {
  try {
    ...
    const msg={studentName:req.user.name, studentEmail:req.user.email, CourseId:courseId,CourseName:courseName,Operation:message}
